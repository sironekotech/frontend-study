...
export default function AppRouterRoutingSamplePage() {
  return (
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
        ...
        <section className="rounded-md border border-[#d8d6c8] bg-white p-6">
          ...
          <p className="mt-5 leading-8 text-[#425466]">
            このページは、Lesson 8のstart時点から用意している遷移サンプルです。
            <code>page.tsx</code> を置いたフォルダがURLになることを確認します。
          </p>
          ...
          <dl className="mt-6 grid gap-4 rounded-md bg-[#f7f7f2] p-4 text-sm leading-6">
            ...
            <div>
              ...
              <dd className="font-mono text-[#15191f]">/next-basics/app-router-routing/sample</dd>
            </div>
          </dl>
        </section>
      </div>
